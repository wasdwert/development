...
function Bonsai_Growing(bonsaixx) {
    if (bonsaixx.growing==1) {   
        ...
        document.getElementById("bonsai_detail_rarity").style.backgroundImage = fetchbonsairarity_big(bonsaixx);
        ...
        document.getElementById("bonsai_detail_type").innerHTML = fetchbonsaiimage_xl(bonsaixx);
